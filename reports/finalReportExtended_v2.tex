...
\item[Supplier selection and procurement.] The network's supplier is fixed and singular; neither policy ever chooses \emph{where} to source from, only how to move what is already committed. Introducing multiple candidate suppliers with their own cost/reliability trade-offs would test a qualitatively different decision -- procurement, not routing -- on the same underlying infrastructure.
